...
echo "
  			...
  			<div id='idiomas'>  
				...
				<a href='".$url."&idioma=en&pais=EN'><img src='http://ligadonospoliticos.com.br/images/bandeiras/ingles.gif' /></a>   
				<br /><br /><br />
				<div id='fb-root'>
				</div>
				<script src='http://connect.facebook.net/en_US/all.js#xfbml=1'>
				</script>
				<fb:like href='http://www.ligadonospoliticos.com.br/' send='true' width='400' show_faces='false' font=''>
				</fb:like>
  			</div>
";
?>
